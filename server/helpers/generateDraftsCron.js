        ...
        /*if(decodedBody.includes("No message body")){
          ...
          const requireReply = await openai.chat.completions.create({
            ...
            messages:[
                ...
                {role:'user', content: `from: ${from}\n subject: ${subject}\nbody: ${decodedBody} \n reply only if its from a real person, and its asking a question or needs a folow up response, No need to reply if its a social media notification or some company commercial,any career site newsletter, ad, or system alert. /n does it need a reply?`},
            ],
          });
